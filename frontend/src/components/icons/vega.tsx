...
export function Vega({ style }: { style?: React.CSSProperties }) {
  return (
    <svg className='icon' viewBox='0 0 59 59' style={style}>
      ...
      <path d='M42.9086 10.7283H37.5455V32.1826H42.9086V10.7283z' />
      <path d='M26.8177 37.5457H21.4546V42.9088H26.8177V37.5457z' />
      <path d='M21.4542 10.7283H16.0911V37.5457H21.4542V10.7283z' />
    </svg>
  )
}
