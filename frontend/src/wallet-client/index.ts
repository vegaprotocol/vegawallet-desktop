  ...
  methods: [
    {
      ...
      result: { name: 'token', schema: { $ref: '#/components/schemas/token' } },
      errors: [
    ...
    },
    {
      ...
      result: {
        ...
        schema: {
          type: 'object',
          properties: { networks: { type: 'array', items: { type: 'string' } } }
        }
      },
      examples: [
        {
    ...
    },
    {
      ...
      result: { name: 'Success', schema: { type: 'null' } },
      examples: [
        {
    ...
    },
    {
      ...
      result: {
        ...
        schema: {
          type: 'object',
          properties: { name: { type: 'string' }, filePath: { type: 'string' } }
        }
      },
      examples: [
        {
        ...
        schema: {
          ...
          properties: {
            permissions: {
              type: 'object',
              properties: {
                hostname1: { $ref: '#/components/schemas/permissions_summary' },
    ...
    },
    {
      ...
      result: {
        name: 'Success',
        schema: { type: 'object', properties: { isValid: { type: 'string' } } }
      }
    },
    {
...
export class WalletClient {
  ...
  ): Promise<ClientConnectWalletResult> => {
  ...
  ): Promise<ClientDisconnectWalletResult> => {
  ...
  ): Promise<ClientGetPermissionsResult> => {
  ...
  ): Promise<ClientRequestPermissionsResult> => {
  ...
  // tslint:disable-next-line:max-line-length
  public ClientListKeys = (
    params: ClientListKeysParams
  ): Promise<ClientListKeysResult> => {
  ...
  ): Promise<ClientSignTransactionResult> => {
  ...
  ): Promise<ClientSendTransactionResult> => {
  ...
  // tslint:disable-next-line:max-line-length
  public ClientGetChainId = (
    params: ClientGetChainIdParams
  ): Promise<ClientGetChainIdResult> => {
  ...
  // tslint:disable-next-line:max-line-length
  public DescribeWallet = (
    params: DescribeWalletParams
  ): Promise<DescribeWalletResult> => {
  ...
  // tslint:disable-next-line:max-line-length
  public DescribeNetwork = (
    params: DescribeNetworkParams
  ): Promise<DescribeNetworkResult> => {
  ...
  // tslint:disable-next-line:max-line-length
  public ImportNetwork = (
    params: ImportNetworkParams
  ...
  public DescribePermissions = (
    params: DescribePermissionsParams
  ...
  // tslint:disable-next-line:max-line-length
  public PurgePermissions = (
    params: PurgePermissionsParams
