  ...
  backend: {
    Handler: {
      ...
      ClearSentTransaction(
        arg1: models.ClearSentTransactionRequest
      ): Promise<Error>
      ConsentToTransaction(
        arg1: models.ConsentToTransactionRequest
      ): Promise<Error>
      CreateWallet(
        arg1: models.CreateWalletRequest
      ): Promise<models.CreateWalletResponse | Error>
      DeleteWallet(arg1: models.DeleteWalletRequest): Promise<Error>
      DescribeKey(
        arg1: models.DescribeKeyRequest
      ): Promise<models.DescribeKeyResponse | Error>
      GenerateKey(
        arg1: models.GenerateKeyRequest
      ): Promise<models.GenerateKeyResponse | Error>
      GetAppConfig(): Promise<models.Config | Error>
      GetConsentRequest(
        arg1: models.GetConsentRequestRequest
      ): Promise<models.ConsentRequest | Error>
      ...
      ImportNetwork(
        arg1: models.ImportNetworkFromSourceRequest
      ): Promise<models.ImportNetworkFromSourceResponse | Error>
      ImportWallet(
        arg1: models.ImportWalletRequest
      ): Promise<models.ImportWalletResponse | Error>
      InitialiseApp(arg1: models.InitialiseAppRequest): Promise<Error>
      IsAppInitialised(): Promise<boolean | Error>
      IsolateKey(
        arg1: models.IsolateKeyRequest
      ): Promise<models.IsolateKeyResponse | Error>
      ListConsentRequests(): Promise<models.ListConsentRequestsResponse | Error>
      ListKeys(
        arg1: models.ListKeysRequest
      ): Promise<models.ListKeysResponse | Error>
      ListNetworks(): Promise<models.ListNetworksResponse | Error>
      ListSentTransactions(): Promise<
        models.ListSentTransactionsResponse | Error
      >
      ListWallets(): Promise<models.ListWalletsResponse | Error>
      SaveNetworkConfig(arg1: models.Network): Promise<boolean | Error>
      SearchForExistingConfiguration(): Promise<
        models.SearchForExistingConfigurationResponse | Error
      >
      SignMessage(
        arg1: models.SignMessageRequest
      ): Promise<models.SignMessageResponse | Error>
