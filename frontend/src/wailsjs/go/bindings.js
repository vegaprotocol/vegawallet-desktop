...
const go = {
  "backend": {
    "Handler": {
       ...
       * @param {ClearApprovedTransactionRequest} arg1 - Go Type: *backend.ClearApprovedTransactionRequest
       * @returns {Promise<Error>}  - Go Type: error
       */
       ...
       * @returns {Promise<GetApprovedTransactionsResponse|Error>}  - Go Type: *backend.GetApprovedTransactionsResponse
       */
      "GetApprovedTransactions": () => {
       ...
       * @returns {Promise<GetPendingTransactionsResponse|Error>}  - Go Type: *backend.GetPendingTransactionsResponse
       */
      "GetPendingTransactions": () => {
