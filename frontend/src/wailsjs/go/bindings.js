...
window.wailsbindings = {"backend":{"Handler":{"AnnotateKey":{"name":"backend.Handler.AnnotateKey","inputs":[{"type":"*wallet.AnnotateKeyRequest"}],"outputs":[{"type":"error"}]},"CheckVersion":{"name":"backend.Handler.CheckVersion","outputs":[{"type":"*backend.CheckVersionResponse"},{"type":"error"}]},"CreateWallet":{"name":"backend.Handler.CreateWallet","inputs":[{"type":"*wallet.CreateWalletRequest"}],"outputs":[{"type":"*wallet.CreateWalletResponse"},{"type":"error"}]},"DescribeKey":{"name":"backend.Handler.DescribeKey","inputs":[{"type":"*wallet.DescribeKeyRequest"}],"outputs":[{"type":"*wallet.DescribeKeyResponse"},{"type":"error"}]},"GenerateKey":{"name":"backend.Handler.GenerateKey","inputs":[{"type":"*wallet.GenerateKeyRequest"}],"outputs":[{"type":"*wallet.GenerateKeyResponse"},{"type":"error"}]},"GetConsoleState":{"name":"backend.Handler.GetConsoleState","outputs":[{"type":"backend.GetServiceStateResponse"}]},"GetNetworkConfig":{"name":"backend.Handler.GetNetworkConfig","inputs":[{"type":"string"}],"outputs":[{"type":"*network.Network"},{"type":"error"}]},"GetServiceState":{"name":"backend.Handler.GetServiceState","outputs":[{"type":"backend.GetServiceStateResponse"}]},"GetTokenDAppState":{"name":"backend.Handler.GetTokenDAppState","outputs":[{"type":"backend.GetServiceStateResponse"}]},"GetVersion":{"name":"backend.Handler.GetVersion","outputs":[{"type":"*backend.GetVersionResponse"}]},"ImportNetwork":{"name":"backend.Handler.ImportNetwork","inputs":[{"type":"*network.ImportNetworkFromSourceRequest"}],"outputs":[{"type":"*network.ImportNetworkFromSourceResponse"},{"type":"error"}]},"ImportWallet":{"name":"backend.Handler.ImportWallet","inputs":[{"type":"*wallet.ImportWalletRequest"}],"outputs":[{"type":"*wallet.ImportWalletResponse"},{"type":"error"}]},"InitialiseApp":{"name":"backend.Handler.InitialiseApp","inputs":[{"type":"*config.Config"}],"outputs":[{"type":"error"}]},"IsAppInitialised":{"name":"backend.Handler.IsAppInitialised","outputs":[{"type":"bool"},{"type":"error"}]},"IsolateKey":{"name":"backend.Handler.IsolateKey","inputs":[{"type":"*wallet.IsolateKeyRequest"}],"outputs":[{"type":"*wallet.IsolateKeyResponse"},{"type":"error"}]},"ListKeys":{"name":"backend.Handler.ListKeys","inputs":[{"type":"*wallet.ListKeysRequest"}],"outputs":[{"type":"*wallet.ListKeysResponse"},{"type":"error"}]},"ListNetworks":{"name":"backend.Handler.ListNetworks","outputs":[{"type":"*network.ListNetworksResponse"},{"type":"error"}]},"ListWallets":{"name":"backend.Handler.ListWallets","outputs":[{"type":"*wallet.ListWalletsResponse"},{"type":"error"}]},"SaveNetworkConfig":{"name":"backend.Handler.SaveNetworkConfig","inputs":[{"type":"*network.Network"}],"outputs":[{"type":"bool"},{"type":"error"}]},"SignMessage":{"name":"backend.Handler.SignMessage","inputs":[{"type":"*wallet.SignMessageRequest"}],"outputs":[{"type":"*wallet.SignMessageResponse"},{"type":"error"}]},"StartConsole":{"name":"backend.Handler.StartConsole","inputs":[{"type":"*backend.StartServiceRequest"}],"outputs":[{"type":"bool"},{"type":"error"}]},"StartService":{"name":"backend.Handler.StartService","inputs":[{"type":"*backend.StartServiceRequest"}],"outputs":[{"type":"bool"},{"type":"error"}]},"StartTokenDApp":{"name":"backend.Handler.StartTokenDApp","inputs":[{"type":"*backend.StartServiceRequest"}],"outputs":[{"type":"bool"},{"type":"error"}]},"StopConsole":{"name":"backend.Handler.StopConsole","outputs":[{"type":"bool"},{"type":"error"}]},"StopService":{"name":"backend.Handler.StopService","outputs":[{"type":"bool"},{"type":"error"}]},"StopTokenDApp":{"name":"backend.Handler.StopTokenDApp","outputs":[{"type":"bool"},{"type":"error"}]},"TaintKey":{"name":"backend.Handler.TaintKey","inputs":[{"type":"*wallet.TaintKeyRequest"}],"outputs":[{"type":"error"}]},"UntaintKey":{"name":"backend.Handler.UntaintKey","inputs":[{"type":"*wallet.UntaintKeyRequest"}],"outputs":[{"type":"error"}]}}}};
const go = {
  "backend": {
    "Handler": {
      /**
